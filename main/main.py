...
while 1 == 1:
    ...
    erste_zahl_stunde = str(zahlen_stunde[0])
    zweite_zahl_stunde = str(zahlen_stunde[1])
    dritte_zahl_stunde = str(zahlen_stunde[2])

    helpers.aufgabe_für_stunde(erster_operator_für_stunde, zweiter_operator_für_stunde, erste_zahl_stunde, zweite_zahl_stunde, dritte_zahl_stunde)
    ...
    helpers.aufgabe_für_minute(erster_operator_für_minute, zweiter_operator_für_minute, erste_zahl_minute, zweite_zahl_minute, dritte_zahl_minute)