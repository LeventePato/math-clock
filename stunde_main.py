...
stunde = 4 #randrange(2, 24)                                                         # TODO: live-Uhrzeit einfügen
...
zweite_operatoration_für_stunde = 1 #randrange(1, 5)                  # 1=+|2=-|3=/|4=*
...
#erste_operatoration_für_minute = #randrange(1,4)
#zweite_operatoration_für_minute = randrange(1,4)
...
if erste_operatoration_für_stunde == 1:                     # x + y ? z
    ...
    if zweite_operatoration_für_stunde == 1:                # x + y + z
        ...
        while ergebnis_erste_rechnung >= stunde - 1 or zweite_zahl % dritte_zahl > 0 or ergebnis_erste_rechnung < 2:       # Bedingungen: Ergebnis kleiner als Uhrzeit (Std), Punkt vor Strich, kein +1/:1
